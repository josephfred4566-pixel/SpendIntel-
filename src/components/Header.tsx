        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            ...
            <div className="hidden lg:flex items-center space-x-2 pl-3 border-l border-slate-200 dark:border-slate-800">
              ...
              {user && (
                <span className="inline-flex items-center px-2 py-0.5 rounded-md text-[11px] font-semibold bg-slate-100 dark:bg-slate-800 text-slate-700 dark:text-slate-300 border border-slate-200 dark:border-slate-700">
                  {user.companyType === 'Corporate' && <Globe className="w-3 h-3 mr-1 text-indigo-600 dark:text-indigo-400" />}
                  {user.companyType === 'Enterprise' && <Layers className="w-3 h-3 mr-1 text-blue-600 dark:text-blue-400" />}
          ...
          <div className="flex items-center space-x-2">
            ...
            <button
              ...
              title="Sync transaction data to running Termux / Local backend server"
              className="inline-flex items-center px-3 py-1.5 border border-indigo-200 dark:border-indigo-800 rounded-lg text-xs font-semibold text-indigo-700 dark:text-indigo-300 bg-indigo-50/80 dark:bg-indigo-950/60 hover:bg-indigo-100 dark:hover:bg-indigo-900 transition-colors shadow-2xs cursor-pointer"
            >
              <RefreshCw className="w-3.5 h-3.5 sm:mr-1.5 text-indigo-600 dark:text-indigo-400" />
                    ...
                    {onSignOut && (
                      <div className="p-1 border-t border-slate-100 dark:border-slate-800 mt-1">
                        <button
                          ...
                          className="w-full flex items-center space-x-2 px-3 py-2 text-xs font-semibold text-rose-600 dark:text-rose-400 hover:bg-rose-50 dark:hover:bg-rose-950/40 rounded-lg transition-colors cursor-pointer"
                        >
